...
def test_loop(whs, all_tiles, t, verbose=True):
...
def solution(n, s, t, verbose=True):
    ...
    if verbose:                
        print('winning hands starter (a pair):', whs)
        # for wh in whs:
        #     print(wh)
    ...
    # 2: pick t triples:
    # (t chows, 0 pungs), (t-1 chows, 1 pung), ..., (0 chows, t pungs)
